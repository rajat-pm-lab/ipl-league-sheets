...
export async function readMatchResults() {
  ...
  return rows.map((r) => ({
    ...
    // Match score data (Week 8 dynamic format) — use parseIntOrNull to handle 0 wickets correctly
    runsHome: r.runs_home !== '' && r.runs_home != null ? parseInt(r.runs_home, 10) : null,
    wicketsHome: r.wickets_home !== '' && r.wickets_home != null ? parseInt(r.wickets_home, 10) : null,
    runsAway: r.runs_away !== '' && r.runs_away != null ? parseInt(r.runs_away, 10) : null,
    wicketsAway: r.wickets_away !== '' && r.wickets_away != null ? parseInt(r.wickets_away, 10) : null,
